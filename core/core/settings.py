...
SECRET_KEY = 'django-insecure-gv^=$ewq8kr5u#-u_&93ws$w5-lf&pgfx*mx$-!-2-tw1&5=lu'
...
INERTIA_VERSION = '1.0'  # pour forcer le cache des assets
...
INERTIA_LAYOUT = BASE_DIR/'frontend/index.html' # required and has no default
